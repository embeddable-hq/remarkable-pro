...
export type FilterBuilderWithGroupingProps = {
...
const FilterBuilderWithGrouping = (props: FilterBuilderWithGroupingProps) => {
  ...
  const handleScrollRight = () => scrollRef.current?.scrollBy({ left: 200, behavior: 'smooth' });
  const handleScrollLeft = () => scrollRef.current?.scrollBy({ left: -200, behavior: 'smooth' });
...
export default FilterBuilderWithGrouping;
