...
import FilterBuilderItemOperatorValueFields from '../../FilterBuilderPro/components/FilterBuilderItemOperatorValueFields';
import { FilterBuilderMemberType, filterByMemberType } from '../FilterBuilderWithGrouping.utils';
...
const FilterBuilderWithGroupingItem = ({
  ...
  const memberTrigger = dimensionOrMeasure ? (
    <button className={styles.memberButton}>{selectedLabel}</button>
  ) : (
