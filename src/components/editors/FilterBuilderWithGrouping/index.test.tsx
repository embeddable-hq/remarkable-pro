...
import FilterBuilderWithGrouping from './index';
import type { DimensionOrMeasure } from '@embeddable.com/core';
import { filterBuilderAndOrOperator, FilterBuilderClause } from '../utils/filterBuilder.utils';
...
describe('FilterBuilderWithGrouping', () => {
  it('renders one placeholder filter when empty', () => {
    render(<FilterBuilderWithGrouping {...defaultProps} />);
  ...
  it('renders an item per top-level node', () => {
    ...
    render(<FilterBuilderWithGrouping {...defaultProps} embeddableState={embeddableState} />);
    expect(screen.getByTestId('filter-item-1')).toBeInTheDocument();
  ...
  it('creates a group (original + picked second filter) via create-group', () => {
    ...
    render(<FilterBuilderWithGrouping {...defaultProps} embeddableState={prev} />);
  ...
  it('handles group-level edits (operator, member, operator, value, search, delete)', () => {
    ...
    render(<FilterBuilderWithGrouping {...defaultProps} embeddableState={groupState()} />);
